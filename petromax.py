...
class HowtoScreen:
	def __init__(self, screen):
		...
		self.text=[util.loadText('Voce acaba de ser contratado pela PetroMax',fontsize, fontcolor, 'vera'),
                util.loadText('Voce deve oleodutos para transportar petroleo dos pocos', fontsize, fontcolor, 'vera'),
		util.loadText('suas refinarias.', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('Voce deve usar pelo menos o numero minimo de dutos', fontsize, fontcolor, 'vera'),
		util.loadText('exigidos pela empresa, caso contrario, perdera o contrato.', fontsize, fontcolor, 'vera'),
		util.loadText('Se ocorrer vazamentos, voce tambEm perdera o contrato;', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('Para cada duto instalado voce ganhara um bonus em dinheiro', fontsize, fontcolor, 'vera'),
		util.loadText('e se o petroleo for transportado com sucesso, voce', fontsize, fontcolor, 'vera'),
		util.loadText('recebera o pagamento.', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('CLIQUE para construir o primeiro tubo, e observe na fila.', fontsize, fontcolor, 'vera'),
                util.loadText('Use a BARRA DE ESPACO para acelerar a vazao', fontsize, fontcolor, 'vera'),
		util.loadText('Pressione F11 para parar a ,musica de fundo', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('BOA SORTE!', fontsize, fontcolor, 'vera'),]
		
		back=util.loadText("Pressione 'ENTER/ESC' para voltar ao menu", 10, fontcolor, 'vera')
...
class HighScoreScreen:
	def __init__(self, screen, highscore):
		...
		title=util.loadText('Melhores Jogadores', 20, fontcolor, 'vera')
		text=[]
		...
		back=util.loadText("Pressione 'ENTER' para voltar ao menu", 10, fontcolor, 'vera')
...
class AskNameScreen:
	def __init__(self, screen):
		...
		title=util.loadText('Digite seu nome:', 20, white, 'vera')
		footer=util.loadText('pressione \'ENTER\'', 11, white, 'vera')
...
class EndScreen:
	def __init__(self, screen):
		...
		self.title=util.loadText('PARABÉNS!', 24, fontcolor, 'vera')
		self.text=[
		util.loadText('Voce fez um otimo trabalho e esta apto', fontsize, fontcolor, 'vera'),
		util.loadText('conquistar o mundo das indústrias petrolíferas.', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('O próximo passo será fundar a sua companhia', fontsize, fontcolor, 'vera'),
		util.loadText('petrolífera e tentar governar este universo! (In', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('Projetado por:', fontsize, fontcolor, 'vera'),
		util.loadText('Maiara de Souza Salmaso', fontsize, fontcolor, 'vera'),
		util.loadText('', fontsize, fontcolor, 'vera'),
		util.loadText('OBRIGADA POR JOGAR!', 18, fontcolor, 'vera'),
		]
		back=util.loadText("Pressione 'ENTER/ESCAPE' para sair", 10, fontcolor, 'vera')
...
class ContractScreen:
	def __init__(self, screen, level, pipes, terrain, pumping,pay):
		...
		back=util.loadText("Pressione 'ENTER' para Entrar, 'ESC' para sair", 10, (0x0,0x0,0x0), 'vera')
		contracttxt=util.loadText("Contrato  "+str(level), 20, (0x0,0x0,0x0), 'vera')
		mintxt=util.loadText("Numero de dutos: "+str(pipes), 10, (0x0,0x0,0x0), 'vera')
		terraintxt=util.loadText("Terreno: "+type, 10, (0x0,0x0,0x0), 'vera')
		temptxt=util.loadText("Bombeando: "+pump, 10, (0x0,0x0,0x0), 'vera')
		paytxt=util.loadText("Pagamento: $"+str(pay), 20, (0x0,0x0,0x0), 'vera')
...
class MainScreen:
	def __init__(self, screen):
		...
		self.start=util.loadText('Novo Jogo', 16, menucolor, 'modernab')
		self.hlstart=util.loadText('Novo Jogo', 16, hgcolor, 'modernab')
		self.cont=util.loadText('Continuar   <-  1  ->', 16, menucolor, 'modernab')
		self.hlcont=util.loadText('Continuar   <-  1  ->', 16, hgcolor, 'modernab')
		self.howto=util.loadText('Como Jogar', 16, menucolor, 'modernab')
		self.hlhowto=util.loadText('Como Jogar', 16, hgcolor, 'modernab')
		self.high=util.loadText('melhores Pontuacoes', 16, menucolor, 'modernab')
		self.hlhigh=util.loadText('Melhores Pontuacoes', 16, hgcolor, 'modernab')
		self.quit=util.loadText('Sair', 16, menucolor, 'modernab')
		self.hlquit=util.loadText('Sair', 16, hgcolor , 'modernab')
		
		self.bg = util.loadPng('mainscreen.png')
		self.menuicon = util.loadPng('menuicon.png')
		self.copyright=util.loadText('Criado por Maiara de Souza Salmaso (C) Copyright 2024', 10, (0xA,0xA,0xA), 'vera')
...
class Game:
	def __init__(self, screen, level, score, highscore):
		...
		self.leveltxt=util.loadText('Nivel '+str(self.level), 18,textcolor , 'engex')
		self.readytxt=util.loadText('Prepare-se!', 36, textcolor, 'engex')
		self.pausetxt=util.loadText('Pause', 36, textcolor, 'engex')
		
		losearray=[util.loadText('Voce falhou', 26, textcolor, 'engex'),
		util.loadText('Voce perdeu o contrato', 26, textcolor, 'engex'),
		util.loadText('Voce está frito(a)!', 26, textcolor, 'engex'), 
		util.loadText('O que voce esta fazendo?', 26, textcolor, 'engex'),
		util.loadText('Proximo!', 26, textcolor, 'engex'),
		util.loadText('Voce perdeu!', 26, textcolor, 'engex'),
		]
		
		self.morepipestxt=util.loadText('Voce precisa de mais dutos', 26, textcolor, 'engex')
		
		winarray=[util.loadText('Bom trabalho!', 26, textcolor, 'engex'),
		util.loadText('Missao completa!', 26, textcolor, 'engex'),
		util.loadText('Voce fez isso', 26, textcolor, 'engex'),
		util.loadText('Parabens!', 26, textcolor, 'engex'),
		util.loadText('Muito bem!', 26, textcolor, 'engex'),
		util.loadText('Voce e o chefe!', 26, textcolor, 'engex'),
		util.loadText('Voce e demais!', 26, textcolor, 'engex'),
		]		
...
if __name__=="__main__":
	pygame.init()
	random.seed()
	pygame.display.set_caption('Petro Max')
