...
class ScoreBar(pygame.sprite.Sprite):
	def __init__(self, pos):
		...
		self.scoretxt=util.loadText('PONTOS', 12, fontcolor, 'ltypewriter')
		self.remainstxt=util.loadText('RESTANTES', 12, fontcolor, 'ltypewriter')
		self.leveltxt=util.loadText('NIVEL', 12, fontcolor, 'ltypewriter')
		self.paytxt=util.loadText('PAGAMENTO', 12, fontcolor, 'ltypewriter')
